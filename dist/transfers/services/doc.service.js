...
const doc_provider_factory_1 = require("./doc-provider.factory");
let DocService = class DocService {
    constructor(docProviderFactory) {
        this.docProviderFactory = docProviderFactory;
    }
    async transferDoc(data, providerId) {
...
exports.DocService = DocService = __decorate([
    ...
    __metadata("design:paramtypes", [doc_provider_factory_1.DocProviderFactory])
], DocService);
